...
greska = 0
turtle.setup(width=1366, height=768, startx=0, starty=0)
...
turtle.pencolor("red")
turtle.write(
    """Kategorije: cities.txt, countries.txt,movies.txt, music.txt, singers.txt., sportists.txt
    """, move=False, align="center", font=("Arial", 12, "italic"))
x = random.randint(1, 15)
turtle.pencolor("black")
kat = turtle.textinput("Unesite kategoriju.",
    "Ime mora zavrsavati s ekstenzijom .txt: ")
...
while j < len(linija) - 1:
    turtle.pendown()
    if linija[j] == " ":
        turtle.write(" ", move=False, align="right",
            font=("Arial", 24, "normal"))
    else:
        turtle.write("_", move=False, align="right",
            font=("Arial", 24, "normal"))
    turtle.penup()
    turtle.forward(25)
    j = j + 1
...
while greska <= 10 and k < len(linija):
    ...
    UnesenaSlova(slovo, len(lista_slova))
    turtle.pencolor("black")
    turtle.penup()
    turtle.goto(50, -150)
    turtle.setheading(0)
    ...
    for i in lista:
        ...
        while i > 0:
            i = i - 1
            turtle.forward(25)
        turtle.write(slovo, move=False, align="right",
            font=("Arial", 24, "normal"))
        k = k + 1
        if k == len(linija):
            turtle.penup()
            ...
            turtle.write("Čestitamo, pobijedili ste!", move=False,
                align="right", font=("Arial", 24, "normal"))
            break
    if len(lista) == 0:
        greska = greska + 1
        CrtajVjesala(greska)
